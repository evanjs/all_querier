...
pub struct CreatorsList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::Person>,
}

impl CreatorsList200Response {
    pub fn new(count: i32, results: Vec<models::Person>) -> CreatorsList200Response {
