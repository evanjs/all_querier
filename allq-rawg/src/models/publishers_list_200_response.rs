...
pub struct PublishersList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::Publisher>,
}

impl PublishersList200Response {
    pub fn new(count: i32, results: Vec<models::Publisher>) -> PublishersList200Response {
