...
pub struct DevelopersList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::Developer>,
}

impl DevelopersList200Response {
    pub fn new(count: i32, results: Vec<models::Developer>) -> DevelopersList200Response {
