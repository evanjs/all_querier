...
pub struct PlatformsList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::Platform>,
}

impl PlatformsList200Response {
    pub fn new(count: i32, results: Vec<models::Platform>) -> PlatformsList200Response {
