...
pub struct StoresList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::Store>,
}

impl StoresList200Response {
    pub fn new(count: i32, results: Vec<models::Store>) -> StoresList200Response {
