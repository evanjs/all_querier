...
pub struct GamesStoresList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::GameStoreFull>,
}

impl GamesStoresList200Response {
    pub fn new(count: i32, results: Vec<models::GameStoreFull>) -> GamesStoresList200Response {
