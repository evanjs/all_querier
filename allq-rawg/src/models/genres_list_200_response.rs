...
pub struct GenresList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::Genre>,
}

impl GenresList200Response {
    pub fn new(count: i32, results: Vec<models::Genre>) -> GenresList200Response {
