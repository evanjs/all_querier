...
pub struct GamesScreenshotsList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::ScreenShot>,
}

impl GamesScreenshotsList200Response {
    pub fn new(count: i32, results: Vec<models::ScreenShot>) -> GamesScreenshotsList200Response {
