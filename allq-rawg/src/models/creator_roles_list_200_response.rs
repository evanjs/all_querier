...
pub struct CreatorRolesList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::Position>,
}

impl CreatorRolesList200Response {
    pub fn new(count: i32, results: Vec<models::Position>) -> CreatorRolesList200Response {
