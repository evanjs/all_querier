...
pub struct GamesDevelopmentTeamList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::GamePersonList>,
}

impl GamesDevelopmentTeamList200Response {
    pub fn new(count: i32, results: Vec<models::GamePersonList>) -> GamesDevelopmentTeamList200Response {
