...
pub struct PlatformsListsParentsList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::PlatformParentSingle>,
}

impl PlatformsListsParentsList200Response {
    pub fn new(count: i32, results: Vec<models::PlatformParentSingle>) -> PlatformsListsParentsList200Response {
