...
pub struct PlatformParentSingle {
    ...
    pub platforms: Vec<models::Platform>,
}

impl PlatformParentSingle {
    pub fn new(name: String, platforms: Vec<models::Platform>) -> PlatformParentSingle {
