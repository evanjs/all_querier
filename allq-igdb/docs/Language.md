...
**name** | Option<**String**> | The name of the localization | [optional]
**native_name** | Option<**String**> | The native name of the language | [optional]
**locale** | Option<**String**> | The combination of Language code and Country code (en-US) | [optional]
