...
**name** | Option<**String**> | The membership type name | [optional]
**description** | Option<**String**> | Description of the membership type | [optional]
**allowed_child_type** | Option<**i32**> | The IGDB object unique identifier | [optional]
**allowed_parent_type** | Option<**i32**> | The IGDB object unique identifier | [optional]
